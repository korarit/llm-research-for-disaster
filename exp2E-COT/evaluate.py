...
def main():
    results_dir = "e:/nlp-for-disaster/exp2E-COT/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 2E-COT)")
    ...
    print(f"\nSaved Exp 2E-COT comparison metrics to {metrics_csv}")
    print(metrics_df)
