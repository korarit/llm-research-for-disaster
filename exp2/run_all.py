...
def main():
    ...
    commands = [
        ([sys.executable, "-u", "e:/nlp-for-disaster/exp2/run_typhoon.py"], "typhoon-v2.5"),
        ([sys.executable, "-u", "e:/nlp-for-disaster/exp2/run_deepseek.py"], "deepseek-v4-flash"),
        ([sys.executable, "-u", "e:/nlp-for-disaster/exp2/run_gemma.py"], "gemma-4")
    ]
    ...
    subprocess.run([sys.executable, "e:/nlp-for-disaster/exp2/evaluate.py"])
