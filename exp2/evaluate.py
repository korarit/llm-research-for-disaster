...
def main():
    results_dir = "e:/nlp-for-disaster/exp2/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 2)")
    ...
    print(f"\nSaved Exp 2 comparison metrics to {metrics_csv}")
    print(metrics_df)
