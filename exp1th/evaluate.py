...
def main():
    results_dir = "e:/nlp-for-disaster/exp1th/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 1TH)")
    ...
    print(f"\nSaved Exp 1TH comparison metrics to {metrics_csv}")
    print(metrics_df)
    
    # Generate chart
    chart_path = os.path.join(results_dir, "th_model_comparison_chart.png")
    generate_chart(metrics_csv, chart_path, "Thai Flat Zero-Shot (Exp 1TH) F1 Comparison")
