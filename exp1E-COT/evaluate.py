...
def main():
    results_dir = "e:/nlp-for-disaster/exp1E-COT/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 1E-COT)")
    ...
    print(f"\nSaved Exp 1E-COT comparison metrics to {metrics_csv}")
    print(metrics_df)
