...
def main():
    results_dir = "e:/nlp-for-disaster/exp3F/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 3F)")
    ...
    print(f"\nSaved Exp 3F comparison metrics to {metrics_csv}")
    print(metrics_df)
