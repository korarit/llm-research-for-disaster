...
def main():
    ...
    commands = [
        (["python", "-u", "e:/nlp-for-disaster/exp3F/run_typhoon.py"], "typhoon-v2.5"),
        (["python", "-u", "e:/nlp-for-disaster/exp3F/run_deepseek.py"], "deepseek-v4-flash"),
        (["python", "-u", "e:/nlp-for-disaster/exp3F/run_gemma.py"], "gemma-4")
    ]
    ...
    subprocess.run(["python", "e:/nlp-for-disaster/exp3F/evaluate.py"], shell=True)
