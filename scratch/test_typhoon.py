...
try:
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You are a disaster response information analyst."},
            {"role": "user", "content": "ช่วยด้วยค่ะ! ตอนนี้เดือดร้อนมาก พิกัด 15.0407, 99.7118 มีคนป่วยหลายคนเลยค่ะ พี่ผู้ชายปวดท้องรุนแรงมาก ติดต่อคุณสุพิชชา จันทร์ดวงศรี ได้ที่เบอร์ 0670889523"}
        ],
        tools=tools,
