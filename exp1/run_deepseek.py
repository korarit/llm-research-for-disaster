...
def main():
    ...
    existing_0_csv = "e:/nlp-for-disaster/exp1/results/deepseek-v4-flash_results.csv"
    ...
    if os.path.exists(existing_0_csv):
        ...
        # Check if temperature column exists, if not, set to 0.0
        df_0['temperature'] = 0.0
        # Reorder columns to make sure they match process_row keys
