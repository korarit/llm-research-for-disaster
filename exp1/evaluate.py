...
def main():
    results_dir = "e:/nlp-for-disaster/exp1/results"
    ...
    for model_name in models:
        ...
        if not os.path.exists(csv_path):
            # Fallback to normal if temp not run yet
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 1)")
    ...
    print(f"\nSaved Exp 1 comparison metrics to {metrics_csv}")
    print(metrics_df)
