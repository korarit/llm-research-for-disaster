...
def main():
    results_dir = "e:/nlp-for-disaster/exp3E-COT/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 3E-COT)")
    ...
    print(f"\nSaved Exp 3E-COT comparison metrics to {metrics_csv}")
    print(metrics_df)
