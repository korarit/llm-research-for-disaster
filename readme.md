...
| สถาปัตยกรรม (Architecture) | Temp | V1 (Original Biased) | V2 (Optimized) | V2-1 | ผลลัพธ์พัฒนาการ (V1 ➡️ V2-1) |
|---|:---:|:---:|:---:|:---:|:---:|
...
| | 0.1 | 0.5774 | 0.5783 | **0.6430** | **+6.56%** *(Seq Peak)* |
...
| | 0.1 | 0.5658 | 0.6197 | 0.5922 | **+2.64%** |
| | 0.2 | 0.5628 | 0.6195 | 0.5835 | **+2.07%** |
| | 0.3 | 0.5717 | 0.6201 | 0.5933 | **+2.16%** |
| **Exp 2E (Joint)** | 0.0 | 0.3985 | 0.6376 | 0.6300 | **+23.15%** 🔥 |
| | 0.1 | 0.4068 | 0.6420 | 0.6221 | **+21.53%** 🔥 |
| | 0.2 | 0.4155 | **0.6493** | 0.6195 | **+20.40%** 🔥 *(V2 Peak)* |
...
> **บทสรุป Category F1**: พัฒนาการที่ยิ่งใหญ่ที่สุดเกิดขึ้นในสถาปัตยกรรม **Joint (Exp 2E)** จาก V1 ไปสู่ V2 ซึ่งแก้ปัญหา Strictness Bias และทำให้ทุกโมเดลพ้นเกณฑ์ `0.60` ขึ้นไปแตะ `0.64` (Typhoon) COT ให้ผลดีในบางจุดของ DeepSeek Joint (+0.0209) และ Gemma-4 Sequential (+0.0035 จนแตะสถิติสูงสุดที่ **`0.6465`**) แต่ไม่ได้ช่วยทุกโมเดลและทุกอุณหภูมิ
...
4. **แนวทางการทดลองในอนาคตเพื่อแตะ F1-score `0.75 - 0.85`**:
