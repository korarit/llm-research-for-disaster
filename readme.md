...
| สถาปัตยกรรม (Architecture) | Temp | V1 (Original Biased) | V2 (Optimized) | V2-1 (Few-Shot) | COT (Short Reasoning) | ผลลัพธ์พัฒนาการ (V1 ➡️ COT) |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **Flat** (Exp 1E) | 0.0 | 0.5749 | 0.6125 | 0.5910 | **0.6166** | **+4.17%** |
