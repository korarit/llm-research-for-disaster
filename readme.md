...
| **Sequential 2-Agent** | deepseek-v4-flash | 0.6034 (V2-1) | 0.7558 | **+0.1524** |
| | gemma-4 | 0.6409 (V2-1) | 0.7111 | **+0.0702** |
| | typhoon-v2.5 | 0.5984 (V2-1) | 0.7377 | **+0.1393** |
...
| **Sequential 2-Agent** | deepseek-v4-flash | 0.8709 (V2-1) | 0.9075 | **+0.0366** |
| | gemma-4 | 0.9026 (V2-1) | 0.9010 | **-0.0016** |
| | typhoon-v2.5 | 0.8505 (V2-1) | 0.9108 | **+0.0603** |

*\*หมายเหตุ: สำหรับชุดข้อมูลภาษาอังกฤษ ค่าเฉลี่ยจะคำนวณจากเวอร์ชันประเมินผลหลักที่ปรับแต่งสมบูรณ์ (Flat และ Joint ใช้ V2 (Optimized), ส่วน Sequential 2-Agent ใช้ V2-1 (Few-Shot) ที่มี Bias Rule ช่วยขจัดข้อผิดพลาดสะสม)*
