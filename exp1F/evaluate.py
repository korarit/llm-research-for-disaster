...
def main():
    results_dir = "e:/nlp-for-disaster/exp1F/results"
    ...
    for model_name in models:
        ...
        for temp in temperatures:
            ...
            plt.title(f"Confusion Matrix (Category) - {model_name} Temp {temp} (Exp 1F)")
    ...
    print(f"\nSaved Exp 1F comparison metrics to {metrics_csv}")
    print(metrics_df)
