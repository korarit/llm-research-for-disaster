...
การทดลองนี้เป็นการนำข้อมูลข้อความแปลภาษาไทยจำนวน 1,000 แถวที่เป็น **ชุดข้อมูลชุดเดียวกันกับที่รันใน Experiment 01TH ทุกประการ** เพื่อเปรียบเทียบเชิงประสิทธิภาพระหว่างการคัดแยกแบบเลเยอร์เดียวและแบบสองเลเยอร์
...
- **แหล่งข้อมูลเข้า (Input Source):** ดึงชุดข้อความและเฉลยความจริงโดยตรงจาก **ไฟล์ผลลัพธ์ข้อมูลทดสอบ 1,000 แถวที่บันทึกสำเร็จมาจาก Experiment 01TH**
